...
<div class="config-bloc-aff">
    ...
    <p class="lws_aff_text_p">
        <?php echo wp_kses(__("Enter here your username and password LWS affiliate, this is the login information by which you reach the <a href='https://affiliation.lws-hosting.com' target='_blank'>affiliate panel LWS</a> LWS", 'lws-affiliation'), $arr) ?>.<br />
        <?php echo wp_kses(__("If you do not have an affiliate LWS account, you can create one in a few minutes from the <a href='https://affiliation.lws-hosting.com/members/addmember' target='__blank' title='Sign LWS Affiliation'>registration page</a>", 'lws-affiliation'), $arr) ?>.
    </p>
    <form method="post">
        <div class="tagsdiv">
            <input type="text" name="username-aff-lws"
                placeholder="<?php echo esc_attr(__('Your affiliate ID', 'lws-affiliation')) ?>"
                class="newtag form-input-tip" />
            <input type="password" name="password-aff-lws"
                placeholder="<?php echo esc_attr(__('Your affiliate password', 'lws-affiliation')) ?>"
                class="newtag form-input-tip" />
